...
const { testing, findAll, findById, update, findByEmail, findByRole, findByHospitalId, findByHospitalName, signin, signup, forgotPassword, resetPassword } = require('../controllers/institutionPersonnel.controller');
